<div class="p-5 gs-secondary-bg min-w-xs flex flex-col justify-between">
    <div>
        ...
        <div class="space-y-10 mt-10">
            <div>
                ...
                <div>
                    <ul>
                        <li
                            class="gs-secondary-text gs-sidebar-hover-active py-2 px-3 text-lg mb-1 flex gap-2 items-center">
